...
def main():
	...
	st.title("ML Famous Datasets Explorer")
	#html_temp = """
	...
	st.sidebar.info("[Instagram](""https://www.linkedin.com/in/vasanth-p-90826218b/"")")
	st.sidebar.markdown("[LinkedInProfile](""https://www.linkedin.com/in/vasanth-p-90826218b/"")")
	st.sidebar.text("Built with Streamlit")
	st.sidebar.text("Maintained by Vasanth")
